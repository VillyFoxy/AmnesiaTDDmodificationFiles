...
private:
	...
	static void __stdcall npcRotation(string& asName, float afAcc, float afGoalSpeed, float playerX, float playerY, float npcX, float npcY, bool abResetSpeed);
	...
	static void __stdcall SetDynamicSnowTexture(string& asName);
	...
	*/
	...
	static float __stdcall GetPlayerRotation();
	...
	static int __stdcall GetPlayerRot();
	static void __stdcall SetTrueFalse(bool trueFalse);
	static bool __stdcall GetTrueFalse();
	static void __stdcall SetPlayerRot(int sideNetwork);
	static void __stdcall SetSide(int side);
	static int __stdcall GetSide();
	static float __stdcall GetPlayerRotY();
	static float __stdcall GetPlayerRotZ();
	...
	static float __stdcall getNetwork(int i);
	static void __stdcall Controls();
	static int __stdcall GetAnimation();
	static int __stdcall GetAnimationNetwork();
	static int __stdcall GetObjNetwork(int i);
	static void __stdcall setPacket(float PosX, float PosY, float PosZ);
	static void __stdcall setObjPacket(int objA, int objB, int objC);
	static bool __stdcall ProcessPacket(Packet& packettype);
	static void __stdcall ClientHandler();
	static void __stdcall startConnection();
